...
def _category_profile(category: str) -> dict[str, Any]:
    profiles: dict[str, dict[str, Any]] = {
        ...
        "www_assets": _profile("high_risk", "Hoog risico", "Bestand kan door dashboards, thema's of kaarten worden gebruikt.", ["Afbeeldingen, scripts of dashboardkaarten kunnen niet meer laden."], ["Zet hetzelfde pad vanuit quarantaine terug en herlaad de browsercache."], "Zoek eerst alle dashboard- en YAML-verwijzingen naar het exacte pad."),

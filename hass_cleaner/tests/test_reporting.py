...
class ReportingTests(unittest.TestCase):
    ...
    def test_073_ui_defaults_to_action_and_caps_large_bundle_details(self) -> None:
        ...
        self.assertIn("function resetScanWorkspace()", javascript)
        self.assertIn("state.selectedEntities.clear()", javascript)
        self.assertIn("state.selectedBundles.clear()", javascript)
        self.assertIn("state.latestPlan = null", javascript)
        self.assertIn("state.entityGroupOpen.clear()", javascript)
        self.assertIn("/summary", javascript)
        self.assertIn("/files?", javascript)
        self.assertIn("/entities?", javascript)
        self.assertIn("/bundles?", javascript)
        self.assertIn("limit=100", javascript)
        self.assertNotIn("function loadFullScan", javascript)
        self.assertNotIn("function finishScan(", javascript)
        self.assertNotIn('name="deletion-mode"', html)
        self.assertNotIn("Direct permanent verwijderen", html)
        self.assertIn("Altijd eerst in quarantaine", html)
        self.assertIn('role="tablist"', html)
        self.assertEqual(8, html.count('role="tab"'))
        ...
        self.assertNotIn("deletion_mode", manifest)
